...
describe('create car specification tests', () => {
  ...
  it('should not be able to add a new specification to an inexistent car', async () => {
    ...
    await expect(createCarSpecificationUseCase.execute({ car_id, specifications_id })).rejects.toEqual(new AppError('Car does not exists', 404));
  });
